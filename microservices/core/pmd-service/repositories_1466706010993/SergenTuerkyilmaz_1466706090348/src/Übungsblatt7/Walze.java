	...
	public String WalzenUnterscheidung() {
		...
		default:
			...
			return "";
																			...
																			//das 1.Zahnrad rotiert im Uhrzeigersinn
	public int countClockwiseRotations(char start, char ziel) {
		...
		if (firstPosition < lastPosition) {
			...
			return (lastPosition - firstPosition) + 26;
																			...
																			// das 2.Zahnrad rotiert gegen den Uhrzeigersinn
	public int countCounterClockwiseRotations(char start, char ziel) {
		...
		if (firstPosition > lastPosition) {
			...
			return (firstPosition - lastPosition) + 26;
																			...
																			// rotateClockwise für erstes Zahnrad --> bestimmt die Posititon des
																			// Buchstabens nach der Rotation -->Zahnrad 1 dreht sich im Uhrzeigersinn
	public char rotateClockwise(char start, int rotation) {
		...
		if (firstPosition + rotation > 25) {
			...
			return permutation.charAt(firstPosition + rotation);
																			...
																			// rotateCounterClockwise für zweites Zahnrad --> bestimmt die Posititon des
																			// Buchstabens nach der Rotation -->Zahnrad 2 dreht sich gegen Uhrzeigersinn
