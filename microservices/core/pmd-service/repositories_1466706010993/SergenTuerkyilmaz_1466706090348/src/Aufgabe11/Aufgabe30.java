			...
			if (primeNumber[i]) {
				...
				if (i > 1) {
					...
					if (i != 0) {
						...
						//hier wird die Primfaktorzerlegung ausgegeben, einmal von der niedrigsten möglichen der liste (0), einmal die höchste mögliche Stelle (101)-1
				...
				System.out.println("////////////////////////////////////////////////////////////");
				System.out.println("");
				System.out.println("Geben Sie eine Zahl ein. Diese wird überprüft, ob sie eine Primzahl ist!: ");
				int y = s.nextInt();
